    ...
    <div className="pb-20 max-sm:mx-0 max-sm:pb-4 max-sm:w-screen bg-gray-100">
      ...
      >
        <div className="flex flex-col justify-center align-items-center text-center w-2/3 max-sm:w-full">
          ...
          <p className="my-5 px-36 max-sm:px-2 max-sm:text-sm">
            Chiller is currently still chilling-in-progress. However, this
            landing page was made with ReactJS and TailwindCSS.
          </p>
          <div className="px-40 text-left flex justify-between max-sm:px-0 max-sm:flex-col max-sm:px-6 ">
          ...
          <p className="my-5 px-36 text-gray-400 underline max-sm:px-2 max-sm:text-sm">
