...
function Hero(props) {
  return (
    <div className="container mx-auto w-2/3 pt-28 rounded-xl flex flex-col justify-evenly align-center">
      <div className="flex">
        <div className="w-1/2 pt-14">
          ...
          <div className="mt-5">
            <button
              type="button"
              class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:opacity-70 focus:ring-1 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm px-10 py-4 text-center mr-2 mb-2 transition duration-300 hover:scale-105"
            >
            ...
            <button
              type="button"
              class="text-black bg-white hover:opacity-70 border border-2 border-primary focus:ring-1 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm px-10 py-3.5 text-center mr-2 mb-2 transition duration-300 hover:scale-105"
            >
              <span class="relative transition ease-in duration-150 rounded-md group-hover:bg-opacity-0">
                Email Us
              </span>
            </button>
          </div>
      ...
      <div className="flex gap-10 mt-5 justify-center align-items-center">
        <img
